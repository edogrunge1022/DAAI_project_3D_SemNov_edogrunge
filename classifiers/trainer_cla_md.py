...
############## modified by edo adding the predictions and the labels of the target domains 
...
##################################################################################
    ...
    eval_ood_sncore(method_id = 4, scores_list=[src_odin, tar1_odin, tar2_odin], src_label=1)
    print("#" * 80)
    ...
    eval_ood_sncore( method_id = 5, scores_list=[src_energy, tar1_energy, tar2_energy], src_label=1)
    print("#" * 80)
    ...
    eval_ood_sncore( method_id = 6, scores_list=[src_gradnorm, tar1_gradnorm, tar2_gradnorm], src_label=1)
    print("#" * 80)
    ...
    eval_ood_sncore(method_id = 7, scores_list=[src_react, tar1_react, tar2_react], src_label=1)
    print("#" * 80)
    return
